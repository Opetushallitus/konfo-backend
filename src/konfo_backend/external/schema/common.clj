...
(def Koulutustyyppi (s/enum "amm" "yo" "amk" "lk" "telma" "tuva" "vapaa-sivistystyo-opistovuosi" "vapaa-sivistystyo-muu" "muu" "amm-osaamisala" "amm-tutkinnon-osa" "amm-muu" "aikuisten-perusopetus"))
(def Amm            (s/eq "amm"))
(def Yo             (s/eq "yo"))
(def Amk            (s/eq "amk"))
(def Lk             (s/eq "lk"))
