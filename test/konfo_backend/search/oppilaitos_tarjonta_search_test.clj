...
(deftest oppilaitos-tarjonta-test
  (comment
    (fixture/add-koulutus-mock traktoriala-oid :koulutustyyppi "amm" :tila "julkaistu" :nimi "Autoalan koulutus" :tarjoajat (str punkaharjun-yliopisto "," helsingin-yliopisto) :sorakuvausId sorakuvausId :metadata koulutus-metatieto)
    ...
    (fixture/add-toteutus-mock valtrakoulu-oid traktoriala-oid :tila "julkaistu" :nimi "Mersukoulutus" :tarjoajat punkaharjun-toimipiste-2 :metadata amk-toteutus-metatieto)
    (fixture/add-toteutus-mock massikkakoulu-oid traktoriala-oid :tila "julkaistu" :nimi "Audikoulutus" :tarjoajat helsingin-toimipiste :metadata toteutus-metatieto :teemakuva "https://example.com/kuva.jpg")

    (fixture/index-oids-without-related-indices {:koulutukset [traktoriala-oid hevosala-oid] :oppilaitokset [punkaharjun-yliopisto, helsingin-yliopisto]} orgs)
    )
